...
<head>
  ...
  <title>Cloud Compliance Pipeline Report - Portfolio by @tmmuniz</title>
  <style>
    body {{
...
<body>
  <div class="card">
    <h1>Cloud Compliance Pipeline Report - Portfolio by @tmmuniz</h1>
  ...
  <div class="card">
    ...
    <p class="meta">This table is generated by matching the same technical control ID from <b>frameworks.yaml</b> to <b>controls.yaml</b>.</p>
    <table>
      <thead>
